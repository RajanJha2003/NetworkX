...
import { Search, Bell, Users, Home, ChevronDown, LogOut, User, Linkedin } from 'lucide-react';
    ...
    <nav className="bg-white shadow-md py-3 px-4 fixed top-0 left-0 right-0 z-50 border-b border-gray-200">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1 sm:space-x-4">
          ...
          <Link to="/notifications" className="flex flex-col items-center text-gray-600 hover:text-blue-600 px-2 transition-colors duration-200 relative">
            <Bell size={20} />
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-10 py-1 border border-gray-200 transition-all">
                ...
                <Link to="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  items-center transition-colors duration-200">
                  <User size={16} className="mr-2 text-gray-500" />
                  View Profile
                </Link>
                
                <Link to="/network" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  items-center transition-colors duration-200">
                  <Users size={16} className="mr-2 text-gray-500" />
                  My Network
                </Link>
                
                <Link to="/logout" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  items-center border-t border-gray-200 transition-colors duration-200">
